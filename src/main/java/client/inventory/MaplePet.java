...
public class MaplePet implements Serializable {
    ...
    public enum PetFlag {
        ...
        AUTO_PICKUP(0x04, 5190003, 5191003), //范围自动捡起功能//取消范围自动捡起功能
        UNPICKABLE(0x08, 5190005, -1), //不拣取特定道具技能
        LEFTOVER_PICKUP(0x10, 5190004, 5191004), //捡起无所有权道具&金币技能//取消捡起无所有权道具&金币功能
        HP_CHARGE(0x20, 5190001, 5191001),//自动服用HP药水技能//取消自动服用HP药水技能
        MP_CHARGE(0x40, 5190006, -1),//自动服用MP药水技能
        PET_BUFF(0x80, -1, -1), //idk
        PET_DRAW(0x100, 5190007, -1), //宠物召唤技能
        PET_DIALOGUE(0x200, 5190008, -1); //宠物自言自语技能
