    ...
    public void applyEffect(MapleCharacter player, MapleMonster monster, boolean skill) {
        ...
        if (gui.Start.ConfigValuesMap.get("怪物状态开关") <= 0) {
            switch (skillId) {
                ...
                case 112:
                case 152:
                    System.out.println("" + monster.stats.getName() + " 使用技能 [防御增幅]");
                    break;
                case 131:
                    System.out.println("" + monster.stats.getName() + " 使用技能 [召唤毒雾]");
                    break;
                case 128:
                    System.out.println("" + monster.stats.getName() + " 使用技能 [诱导]");
                    break;
                case 103:
                case 113:
                case 153:
                    System.out.println("" + monster.stats.getName() + " 使用技能 [魔法防御增幅]");
                    break;
                case 110:
                case 150:
                    System.out.println("" + monster.stats.getName() + " 使用技能 [物理攻击增幅]");
                    break;
                case 101:
                case 111:
                case 151:
                    System.out.println("" + monster.stats.getName() + " 使用技能 [魔法攻击增幅]");
                    break;
                case 120:
                    System.out.println("" + monster.stats.getName() + " 使用技能 [封印]");
                    break;
                case 121:
                    System.out.println("" + monster.stats.getName() + " 使用技能 [黑暗]");
                    break;
                case 122:
                    System.out.println("" + monster.stats.getName() + " 使用技能 [弱化]");
                    break;
                case 124:
                    System.out.println("" + monster.stats.getName() + " 使用技能 [诅咒]");
                    break;
                case 114:
                    System.out.println("" + monster.stats.getName() + " 使用技能 [治愈]");
                    break;
                case 140:
                    System.out.println("" + monster.stats.getName() + " 使用技能 [物理无效]");
                    break;
                case 141:
                    System.out.println("" + monster.stats.getName() + " 使用技能 [魔法无效]");
                    break;
                case 200:
                    System.out.println("" + monster.stats.getName() + " 使用技能 [召唤小弟]");
                    break;
                default:
                    System.out.println("" + monster.stats.getName() + " 使用技能 " + skillId);
                    break;
            }
        }
        switch (skillId) {
