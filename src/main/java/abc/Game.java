...
public class Game {
    ...
    //服务端名称
    public static String 服务端名称 = "Sammy 079";
    //服务端名称
    public static String 安全系统 = "<安全防护>\r\n\r\nVer.1.0\r\n\r\n";
    //服务端名称
    public static String 官方网站 =  "www.baidu.com";
    //服务端名称
    public static String 更新程序 = "更新程序.exe";
    //服务端版本号
    public static int 版本 = 26;
    //禁止未认证脚本使用*
    public static String 窗口标题 = "-Sammy 079";
    //客户端版本号ZEVMS更新程序
    public static final short 检测客户端版本1 = 79;
    //客户端版本号2
    public static final String 检测客户端版本2 = "1";
    //频道端口
    public static int 商城端口 = 7585;
    //作者QQ
    public static String 作者QQ = "513251863";
    //作者
    public static String 作者昵称 = "-Sammy";
    //官方群
    public static String 官方群号 = "513251863";
    //人数限制
    public static int 人数限制 = 3000;
    //官方群链接
    public static String 官方群链接 = "https://baidu.com";
    //服务端网速检测指定IP
    public static String IP地址 = "127.0.0.1";
    //单机体验过期时间
    public static String 过期时间 = "2090-05-01 00:00";
    //从网络获取时间
    public static String 获取网络时间 = "http://www.baidu.com";
    //当前网络时间
    public static String 当前时间 = "" + 获取网络时间(获取网络时间) + "";
    //每日清理在线时间（准备）
    public static int 清理每日在线时间 = 1;
    //每日清理在线时间（开始清理）
    public static int 准备清理每日在线时间 = 23;
    //服务端自动定时重启（准备）
   ...
   //服务端开服名字*引用配置文件
    ...
    //友情链接
    public static String 游峰论坛官网 = "https://www.baidu.com";
    public static String ZEVMS官网 = "https://www.baidu.com";
    ...
    public static boolean 编辑器授权() throws IOException {
        ...
        if (r.equals(f)) {
            ...
            JOptionPane.showMessageDialog(null, "你没有使用的权限。");
            return false;
        }
    }
    ...
    public static boolean 记录通过授权码() throws IOException {
        ...
        FileoutputUtil.logToZev("服务端信息文件/服务端授权码记录"
                + "/" + 开服名字 + ".txt",
                "时间:" + CurrentReadable_Date() + "\r\n"
                + "授权码1:" + f + "\r\n"
                + "授权码2:" + r + "\r\n"
                + "配置IP:" + MapleParty.IP地址 + "\r\n\r\n");
        return true;
    }
    ...
    public static boolean 授权码() throws IOException {
        ...
        if (r.equals(f)) {
            FileoutputUtil.logToFile("Togan/脚本编辑器授权码.txt", "" + f + "\r\n");
            return true;
        } else {
            FileoutputUtil.logToFile("Togan/脚本编辑器授权码.txt", "" + f + "\r\n");
            return false;
