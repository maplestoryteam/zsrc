 ...
 */
public class 充值卡后台 extends javax.swing.JFrame {
    ...
    public 充值卡后台() {
        ...
        setTitle("Maplestory(079)v." + 版本 + "    【充值/兑换卡控制台，可关闭】");
        initComponents();
        刷新充值卡信息();
    ...
    public void 生成自定义充值卡2() {
        ...
        try (Connection con = DatabaseConnection.getConnection(); PreparedStatement ps = con.prepareStatement("INSERT INTO nxcodez ( code,leixing,valid) VALUES ( ?, ?, ?)")) {
            ...
            Logger.getLogger(充值卡后台.class.getName()).log(Level.SEVERE, null, ex);
        }
        充值卡信息输出(输出);
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(充值卡后台.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        //</editor-fold>
        充值卡后台.setDefaultLookAndFeelDecorated(true);
