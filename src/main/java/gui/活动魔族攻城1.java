...
public class 活动魔族攻城1 {
    ...
    public static void 魔族攻城线程() {
        if (魔族攻城线程 == null) {
            ...
            群通知("[城镇警报] : 据有效情报，魔族大军正在2频道林中之城处集结，恐怕要兵临城下了，射手村，勇士部落，废弃都市，魔法密林，这四转城镇危在旦夕，向冒险家们发出援助请求。");
    ...
    public static void 攻城部队B() {
        ...
        if (时 == 21 && 分 == 10 && B == 0) {
            ...
            群通知("[魔族攻城] : " + 信息 + " 兵力 " + MapleParty.蝙蝠魔B部队);
    ...
    public static void 攻城部队C() {
        ...
        if (时 == 21 && 分 == 10 && C == 0) {
            ...
            群通知("[魔族攻城] : " + 信息 + " 兵力 " + MapleParty.蝙蝠魔C部队);
            World.Broadcast.broadcastMessage(MaplePacketCreator.serverNotice(6, "[魔族攻城] : " + 信息));
            C = 1;
            /**
             * <#################################第二图###################################>
    ...
    public static void 攻城部队D() {
        ...
        if (时 == 21 && 分 == 10 && D == 0) {
            ...
            群通知("[魔族攻城] : " + 信息 + " 兵力 " + MapleParty.蝙蝠魔D部队);
            World.Broadcast.broadcastMessage(MaplePacketCreator.serverNotice(6, "[魔族攻城] : " + 信息));
            D = 1;
            /**
             * <#################################第二图###################################>
