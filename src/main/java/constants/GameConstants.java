...
public class GameConstants {
    ...
    private static final int[] exp = {
        0, 15, 34, 57, 92, 135, 372, 560, 840, 1242, 1716,//11
        2360, 3216, 4200, 5460, 7050, 8840, 11040, 13716, 16680, 20216,//21
        24402, 28980, 34320, 40512, 47216, 54900, 63666, 73080, 83720, 95700,//31
        108480, 122760, 138666, 155540, 174216, 194832, 216600, 240500, 266682, 294216,//41
        324240, 356916, 391160, 428280, 468450, 510420, 555680, 604416, 655200, 709716, // 51
        748608, 789631, 832902, 878545, 926689, 977471, 1031036, 1087536, 1147132, 1209994,//61
        1276301, 1346242, 1420016, 1497832, 1579913, 1666492, 1757815, 1854143, 1955750, 2062925, // 71
        2175973, 2295216, 2410993, 2553663, 2693603, 2841212, 2996910, 3161140, 3334370, 3517093,//81
        3709829, 3913127, 4127566, 4353756, 4592341, 4844001, 5109452, 5389449, 5684790, 5996316,//91
        6324914, 6671519, 7037118, 7422752, 7829518, 8258575, 8711144, 9188514, 9692044, 10223168, // 101
        10783397, 11374327, 11997640, 12655110, 13348610, 14080113, 14851703, 15665576, 16524049, 17429566,//111
        18384706, 19392187, 20454878, 21575805, 22758159, 24005306, 25320796, 26708375, 28171993, 29715818,//121
        31344244, 33061908, 34873700, 36784778, 38800583, 40926854, 43169645, 45535341, 48030677, 50662758,//131
        53439077, 56367538, 59456479, 62714694, 66151459, 69776558, 73600313, 77633610, 81887931, 86375389,//141
        91108760, 96101520, 101367883, 106922842, 112782213, 118962678, 125481832, 132358236, 139611467, 147262175,//151
        ...
        451506220, 476248760, 502347192, 529875818, 558913012, 589541445, 621848316, 655925603, 691870326, 729784819,//180
        769777027, 811960808, 856456260, 903390063, 952895838, 1005114529, 1060194805, 1118293480, 1179575962, 1244216724,//190
        1312399800, 1384319309, 1460180007, 1540197871, 1624600714, 1713628833, 1807535693, 1906588648, 2011069705, 2121276324,//200
        2121276324, 2121276324, 2121276324, 2121276324, 2121276324, 2121276324, 2121276324, 2121276324, 2121276324, 2121276324,//210
        2121276324, 2121276324, 2121276324, 2121276324, 2121276324, 2121276324, 2121276324, 2121276324, 2121276324, 2121276324,//220
        2121276324, 2121276324, 2121276324, 2121276324, 2121276324, 2121276324, 2121276324, 2121276324, 2121276324, 2121276324,//230
        2121276324, 2121276324, 2121276324, 2121276324, 2121276324, 2121276324, 2121276324, 2121276324, 2121276324, 2121276324,//240
        2121276324, 2121276324, 2121276324, 2121276324, 2121276324, 2121276324, 2121276324, 2121276324, 2121276324, 2121276324//250
    ...
    public static boolean 金锤子不能使用在此物品(final int itemId) {
        switch (itemId) {
            case 1122000://黑龙项环
    ...
    public static int getExpNeededForLevel(final int level) {//钓鱼相关
    ...
    public static int getClosenessNeededForLevel(final int level) {//宠物
        return closeness[level - 1];
    }

    public static int getMountExpNeededForLevel(final int level) {//宠物
    ...
    public static boolean 骑士团职业(final int job) {
        return job >= 1000 && job < 2000;
    }

    public static boolean 冒险家职业(final int job) {
        return job >= 1000 && job < 2000;
    }
    ...
    public static int getLinkedAranSkill(final int id) {//战神技能
        switch (id) {
            case 21110007:
            case 21110008:
                return 21110002;
    ...
    public static boolean isThrowingStar(final int itemId) {
        return itemId / 10000 == 207;//海星镖
    }

    public static boolean isBullet(final int itemId) {
        return itemId / 10000 == 233;//子弹
    }
    ...
    public static boolean isCleanSlate(int itemId) {
        return itemId / 100 == 20490;//白医卷轴
    }

    public static boolean isAccessoryScroll(int itemId) {
        return itemId / 100 == 20492;//配饰力量卷轴70%
    }
    ...
    public static int getTaxAmount(final int meso) {//交易的金币
        if (meso >= 100000000) {
...
//    };
    ...
    public static int[] 天堂谷粉丝 = {1142227};
    public static int[] 天堂谷认证 = {1142544};

    public static int Equipment_Bonus_EXP(final int itemid) { // TODO : Add Time for more exp increase//经验
        switch (itemid) {
            case 1122017://精灵吊坠
                return 10;
        }
    ...
    public static int Premium_Bonus_EXP(final int itemid) { // TODO : Add Time for more exp increase//经验
        switch (itemid) {
            case 1142227:
                return 10;
        }
    ...
    public static int 天堂谷粉丝(final int itemid) { // TODO : Add Time for more exp increase//经验
        switch (itemid) {
            case 1142227:
                return 50;
        }
    ...
    public static int 天堂谷认证(final int itemid) { // TODO : Add Time for more exp increase//经验
        switch (itemid) {
            case 1142544:
                return 100;
        }
    ...
    public static int getFishingTime() {
        ...
        int 钓鱼时间 = gui.Start.ConfigValuesMap.get("钓鱼时间");
...
//        
//        
//        int 钓鱼时间 = server.Start.ConfigValuesMap.get("钓鱼时间");
//        
//       
//        return 1000 * 钓鱼时间;//钓鱼时间
//        //return 1000 * Integer.parseInt(ServerProperties.getProperty("ZEV.dysj"));//钓鱼时间
...
//    }
    ...
    public static boolean 全屏技能(int skill) {//战士技能
        switch (skill) {
            case 1311006://龙咆哮
            case 1221011://圣域  
            case 2121007://天降落星
...
//            default:
    ...
    public static List<Balloon> getBalloons() {
        if (lBalloon.isEmpty()) {
            //lBalloon.add(new Balloon(ServerProperties.getProperty("ZEV.CommandMessage"), 250, 100));
            //lBalloon.add(new Balloon("服务器启动时间        " + CurrentReadable_Date(), 250, 150));
            if (MapleParty.容纳人数 != 999) {
                lBalloon.add(new Balloon("Sammy：" + 作者QQ, 40, 300));
            }
        }
        return lBalloon;
    }
